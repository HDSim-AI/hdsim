...
The Chain-of-Planned-Behaviour prompts are NOT here. They differ per domain and live in the
domain package, because a travel prompt applied to a relocation decision produces a confident
wrong answer with nothing to flag it.
